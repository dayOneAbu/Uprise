        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="#" className="hover:text-white transition-colors">Find Internships</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">Skill Tests</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="#" className="hover:text-white transition-colors">Find Talent</Link></li>
