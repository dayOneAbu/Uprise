...
const Option = ({ Icon, title, href, activePath, exact, open, notifs }: OptionProps) => {
    const pathname = usePathname();
    const isSelected = exact ? pathname === href : pathname.startsWith(activePath);
