            ...
            >
                ...
                <div className="grid grid-cols-2 gap-6">
                    <div className="bg-white/5 p-4 rounded-xl border border-white/10">
                        ...
                        <p className="text-sm text-blue-200">Verified Interns</p>
                    </div>
                    <div className="bg-white/5 p-4 rounded-xl border border-white/10">
                        <h3 className="text-2xl font-bold text-white mb-1">98%</h3>
                        <p className="text-sm text-blue-200">Match Success</p>
                    </div>
                </div>
            </motion.div>
         </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            <div className="mb-8">
                ...
                <p className="text-gray-500 mt-2">Join thousands of companies hiring on MeritMatch.</p>
            </div>
            ...
            <div className="text-center mt-6 text-sm">
                ...
                <a href="/employer/auth/login" className="text-blue-600 font-medium hover:underline">Log in</a>
            </div>
        </div>
      </div>
    </div>
